...
const comparisons = [
  ...
  },
  {
    ...
    localPinyin:
      "Shīfu, wǒ shì yào qù rénmín guǎngchǎng. Néng zǒu nà tiáo lù ma?",
...
const researchSources = [
  {
    year: "2013",
    source: "국내 언어교육 연구",
    focus: "교재 표현과 현지 표현 사이의 거리",
  },
  {
    year: "2017",
    source: "SAGE Journals",
    focus: "말하기 불안과 의사소통 의지의 관계",
  },
  { year: "2022", source: "한국교원대학교", focus: "VR 학습 환경의 몰입 경험" },
  {
    year: "2025",
    source: "AI Hub",
    focus: "한국인 중국어 학습자 음성 데이터 기반 자동평가",
  },
];
...
const steps = [
  {
    no: "01",
    title: "가입하기",
    text: "간단한 정보로 학습 공간을 엽니다.",
    icon: Sparkles,
  },
  {
    no: "02",
    title: "레벨 테스트",
    text: "짧은 대화로 현재 말하기 수준을 확인합니다.",
    icon: Compass,
  },
  {
    no: "03",
    title: "시나리오 선택",
    text: "오늘 필요한 실제 상황을 골라봅니다.",
    icon: BookOpenCheck,
  },
  {
    no: "04",
    title: "AI와 대화 연습",
    text: "부담 없이 여러 번 말해볼 수 있습니다.",
    icon: Headphones,
  },
  {
    no: "05",
    title: "피드백 리포트",
    text: "상황에 맞는 다음 연습 지점을 확인합니다.",
    icon: FileText,
  },
];
...
const cycleSteps = [
  {
    no: "①",
    title: "오늘의 상황 정하기",
    text: "지금 나에게 필요한 대화 하나를 골라 시작합니다.",
    icon: Compass,
  },
  {
    no: "②",
    title: "AI와 대화하기",
    text: "부담 없이 여러 번 실제처럼 말해봅니다.",
    icon: Headphones,
  },
  {
    no: "③",
    title: "피드백 확인하기",
    text: "발음·표현·현지 말투에서 다듬을 지점을 짚어줍니다.",
    icon: BrainCircuit,
  },
  {
    no: "④",
    title: "약한 지점 다시 연습하기",
    text: "짚어준 부분만 짧게, 다시 소리 내어 말해봅니다.",
    icon: RotateCcw,
  },
];
...
export default function Home() {
  ...
  const [waitlistSource, setWaitlistSource] = useState<"trial" | "diagnostic">(
    "trial"
  );
      ...
      <main id="top">
            ...
            <motion.div {...reveal} className="hero-copy">
              ...
              <div className="hero-actions">
                <button className="button button-solid" onClick={handleTrial}>
                  AI 회화 무료 체험하기 <ArrowDownRight size={18} />
                </button>
                <button
                  className="button button-ghost"
                  onClick={handleDiagnostic}
                >
                  내 중국어 실력 진단받기 <ArrowRight size={18} />
                </button>
              </div>
          ...
          <div className="page-frame rail-layout">
            ...
            <motion.div {...reveal} className="problem-content">
              <p className="lead-copy">
                문법과 교과서 문장은 알지만, 실제 중국인과 대화하는 순간에는
                배운 중국어가 자연스럽게 나오지 않을 때가 있습니다.
              </p>
              <div className="problem-list">
                <article>
                  <span>01</span>
                  <h3>교재 표현과 현지 표현의 괴리</h3>
                  <p>
                    상황에 꼭 맞는 어조와 말끝은, 암기한 한 문장보다 한 번 더
                    실제로 말해보며 익힐 수 있습니다.
                  </p>
                </article>
                <article>
                  <span>02</span>
                  <h3>말하기 불안과 실전 기회의 부족</h3>
                  <p>
                    사람 앞에서 바로 말하기 부담스러운 순간에도, AI와 먼저
                    대화를 꺼내볼 수 있습니다.
                  </p>
                </article>
                <article>
                  <span>03</span>
                  <h3>내 실력을 가늠하기 어려움</h3>
                  <p>
                    현재 수준과 필요한 연습을 확인하고, 나에게 맞는 대화
                    상황부터 시작해볼 수 있습니다.
                  </p>
                </article>
              </div>
        ...
        <section className="section story-section">
          <div className="page-frame story-grid">
            <motion.div {...reveal} className="story-visual-wrap">
              <img
                src={STORY_IMAGE}
                alt="언어 교육 현장 경험을 상징하는 노트와 아카이브 오브제"
            ...
            <motion.div {...reveal} className="story-copy">
              ...
              <p>
                중국에서 나고 자라 현지 대학까지 마친 창립자는 2004년 한국에서
                중국어 강사로 시작했습니다. 통역사와 중국 현지 유치원 강사로
                오랜 시간을 보내며, 학습자가 현실의 대화 앞에서 잠시 멈추는
                순간을 반복해서 마주했습니다.
              </p>
              <p>
                커짠은 그 간격을 줄이기 위해, 오늘 바로 마주칠 수 있는 상황을
                대화로 연습하는 곳입니다.
              </p>
              <button
                className="text-link"
              ...
              >
                어떤 대화를 연습하는지 보기 <ArrowRight size={17} />
              </button>
            </motion.div>
          </div>
        </section>
          ...
          <div className="page-frame">
            ...
            <div className="scenario-layout">
              <motion.figure {...reveal} className="scenario-feature">
                <img
                  src={CAFE_IMAGE}
                  alt="카페에서 AI와 중국어 주문 회화를 연습하는 장면"
                />
                <figcaption>
                  <span>SCENE 01</span>
                  <strong>카페에서 주문하기</strong>
                  <small>
            ...
            <motion.div {...reveal} className="feedback-panel">
              ...
              <div>
                ...
                <h3>대화가 끝나면, 그 장면 안에서 다시 봅니다.</h3>
              </div>
              <p>
                카페에서 주문하는 대화를 마치면 AI가 발음이 자연스러웠는지,
                상황에 맞는 표현을 썼는지, 현지인이 쓰는 말투에 가까웠는지를
                짚어줍니다. 딱딱한 채점표가 아니라 다음에 무엇을 더 연습하면
                좋을지 알려주는 방식입니다.
              </p>
            </motion.div>
          </div>
          ...
          <div className="page-frame">
            ...
            <motion.div {...reveal} className="expression-table-wrap">
              <div className="expression-table">
                ...
                {comparisons.map(row => (
                  <div className="expression-row" key={row.situation}>
            ...
            <p className="source-note">
              예문은 실제 사용 맥락을 이해하기 위한 학습 예시입니다. 지역과
              상대, 상황에 따라 자연스러운 표현은 달라질 수 있습니다.
            </p>
          </div>
        </section>
        ...
        <section className="section evidence-section">
          <div className="page-frame rail-layout evidence-layout">
            ...
            <motion.div {...reveal}>
              <p className="lead-copy">
                커짠은 교재와 실전 표현의 차이, 말하기 불안, 몰입형 회화 연습에
                관한 언어교육 연구를 학습 설계의 참고점으로 삼습니다.
              </p>
              ...
              <div className="evidence-disclaimer">
                <span>NOTE</span>
                <p>
                  커짠의 자체 학습 데이터와 성장 지표는 실제 수집 및 검토가
                  완료되는 대로 투명하게 안내할 예정입니다. 임의의 효과 수치는
                  사용하지 않습니다.
                </p>
              </div>
            </motion.div>
          ...
          <div className="page-frame voices-layout">
            ...
            <motion.div {...reveal} className="voice-cards">
              <figure>
                <Quote size={25} />
                <blockquote>
                  “문장이 완벽해서도 아니고, 그냥 입 밖으로 안 나와요.
                  머릿속에서는 아는데 말하려고 하면 멈칫하게 돼요.”
                </blockquote>
                <figcaption>— 말하기 전의 망설임</figcaption>
              </figure>
              <figure>
                <Quote size={25} />
                <blockquote>
                  “교과서에는 ‘对不起’를 쓰는데, 실제로는 ‘不好意思’를 더 자주
                  쓰더라고요. 처음에 당황했어요.”
                </blockquote>
                <figcaption>— 표현의 온도 차이</figcaption>
              </figure>
            </motion.div>
          </div>
        </section>
        ...
        <section className="section cycle-section">
          <div className="page-frame">
            ...
            <motion.div {...reveal} className="cycle-repeat">
              <RotateCcw size={17} />
              <span>
                이 흐름은 다시 <b>① 오늘의 상황 정하기</b>로 이어집니다. 하루 한
                번, 며칠에 걸쳐 반복하는 것이 커짠의 학습 방식입니다.
              </span>
            </motion.div>
          </div>
        </section>
        ...
        <section className="cta-section">
          <div className="page-frame cta-inner">
            <motion.div {...reveal}>
              ...
              <p>
                정식 요금제는 준비 중입니다. 지금은 무료 체험 소식과 이용 안내를
                먼저 받아보세요.
              </p>
            </motion.div>
            <motion.div {...reveal} className="cta-actions">
              ...
              <button className="button button-light" onClick={handleTrial}>
                무료체험 시작하기 <ArrowDownRight size={18} />
              </button>
              <button
                className="button button-line-light"
                onClick={() => scrollTo("#contact")}
              >
                요금 및 제휴 문의하기 <ArrowRight size={18} />
              </button>
            </motion.div>
          </div>
        </section>
          ...
          <div className="page-frame faq-layout">
            <motion.div {...reveal} className="faq-intro">
              <SectionIntro
                index="10"
                eyebrow="FAQ"
                title="궁금한 점을 먼저 정리했습니다."
              />
              <p>
                서비스 형태와 상세 연락처는 확정되는 대로 안내를
                업데이트하겠습니다.
              </p>
            </motion.div>
          ...
          <div className="page-frame">
            ...
            <div className="fit-grid">
              <motion.article {...reveal} className="fit-card good-fit">
                ...
                <ul>
                  <li>
                    문법과 기본 표현은 알지만 실전에서 말이 잘 안 나오는 학습자
                  </li>
                  <li>교과서 중국어와 현지 표현의 차이가 궁금한 학습자</li>
                  <li>중국 여행·출장 전 실전 대화를 미리 연습하고 싶은 분</li>
                  <li>
                    사람 앞에서 말하기에 부담을 느껴 AI와 먼저 연습해보고 싶은
                    분
                  </li>
                  <li>정해진 시간표 없이 스스로 반복 연습하고 싶은 분</li>
                </ul>
              </motion.article>
              <motion.article {...reveal} className="fit-card other-fit">
                <div className="fit-card-title">
                  <span>△</span>
                  <h3>다음과 같은 경우엔 참고해주세요</h3>
                </div>
                <ul>
                  <li>
                    <strong>문법을 처음부터 체계적으로 배우고 싶다면</strong>{" "}
                    기초 문법 강의와 병행하는 것이 도움이 될 수 있습니다.
                  </li>
                  <li>
                    <strong>HSK 등 공인 시험 대비가 목적이라면</strong> 커짠은
                    시험 대비보다 실전 회화에 초점을 둡니다.
                  </li>
                  <li>
                    <strong>정기적인 대면·화상 수업을 원한다면</strong> 사람
                    강사와의 수업 방식이 더 적합할 수 있습니다.
                  </li>
                  <li>
                    <strong>인터넷이나 음성 인식 환경이 불안정하다면</strong>{" "}
                    이용에 제약이 있을 수 있습니다.
                  </li>
                </ul>
              </motion.article>
          ...
          <div className="page-frame contact-grid">
            <motion.div {...reveal} className="contact-copy">
              ...
              <div className="contact-aside">
                ...
                <p>
                  이메일·전화·카카오톡 등 직접 연락처는 서비스 형태와 함께
                  확정되는 대로 추가될 예정입니다.
                </p>
              </div>
            </motion.div>
            {contactSubmitted ? (
              <motion.div {...reveal} className="contact-form contact-success">
                <Check size={28} />
                <h3>문의가 접수되었습니다.</h3>
                <p>남겨주신 이메일로 순서대로 답변드리겠습니다.</p>
                <button
                  type="button"
                  className="text-link"
                  onClick={() => setContactSubmitted(false)}
                >
                  다른 문의 남기기 <ArrowRight size={17} />
                </button>
              </motion.div>
            ) : (
              <motion.form
              ...
              >
                ...
                <label>
                  ...
                  <select name="inquiryType" defaultValue="일반 문의">
                    <option>일반 문의</option>
                    <option>제휴 문의</option>
                    <option>학원·기업용 도입 문의</option>
                    <option>요금 관련 문의</option>
                  </select>
                </label>
                <label>
                  문의 내용
